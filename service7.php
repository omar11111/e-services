      ...
      <div id="introCarousel" class="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/img/tour.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>الخدمات السياحية</h2>
                <p>في هذه الصفحة يتم عرض مجموعة من الخدمات السياحية المختلفة </p>
    ...
    <section id="portfolio" class="section-bg">
      ...
      <div class="container">
        ...
        <?php
          ...
          $sql = "SELECT * FROM services where webtype='tourism' order by RAND() limit 200 ";
