      ...
      <div id="introCarousel" class="carousel" >
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/img/edu.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>الخدمات التعليمية</h2>
                <p>في هذه الصفحة يتم عرض مجموعة من الخدمات التعليمية المختلفة </p>
    ...
    <section id="portfolio" class="section-bg">
     ...
     <div class="row portfolio-container ">
      ...
      <?php
        ...
        $sql = "SELECT * FROM services where webtype='Educational' order by RAND() limit 200 ";
