...
<br>
              ...
              <!-- btn regestration -->
                    <div class="form-group">       
                        <button type="submit"  name="search" class="btn btn-lg btn-block " style="background-color:#162030;color: white">بحث </button>

                    </div>
            
<div class="form-group">  
<a class="btn btn-lg btn-block " style="background-color:#162030;color: white"  href="edit2.php">تعديل الموقع </a>
