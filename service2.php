      ...
      <div id="introCarousel" class="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          <div class="carousel-item active">
            <div class="carousel-background"><img src="assets/img/helath.jpg" alt=""></div>
            <div class="carousel-container">
              <div class="carousel-content">
                <h2>الخدمات الصحية</h2>
                <p>في هذه الصفحة يتم عرض مجموعة من الخدمات الصحية المختلفة </p>
...
<div class="container">
  ...
  <?php
    ...
    $sql = "SELECT * FROM services where webtype='Healthy' order by RAND() limit 200 ";
